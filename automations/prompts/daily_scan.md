...
硬规则：
1. 国内项目是默认主线。优先看国内团队、国内开发者、国内 Demo/试玩、国产独立游戏、B站已有视频/讨论、中文社区有真实讨论的项目。
2. 海外项目默认降权。只有在已有 PC 公开数据验证为大爆款，并且能讲清楚手游化/移动端改编角度时，才保留为观察或专题研究线索。
3. 排除：PC Early Access、叙事主导、印度团队。
4. 已有成熟发行商且中国能力已占位的项目，通常降权或淘汰。
5. 已经发售的项目不进人工复核候选；除非用户明确要求复盘，只能作为淘汰原因或市场背景。60 天不是唯一窗口，国内前期项目可以看得更早更长；国内开发者 Demo/试玩信号需要提权。
6. Demo/公开口碑过低（<80%）直接淘汰。

每日扫描阵地，按优先级：
1. 国内游戏媒体、B站视频/搜索、indienova、中文开发者社区、TapTap/好游快爆/国内测试平台、开发者/工作室官方号
2. Steam 新商店页 / Demo 页 / Steam News，尤其是国内开发者 Demo/试玩信号
3. GamesPress / PR 新闻稿
4. YouTube Trailer / 官方频道
5. B站 / indienova / 中文社区
6. 其他弱信号站点
