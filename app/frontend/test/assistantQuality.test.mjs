...
import { analyzeAssistantDraft, buildAssistantResultGroups, buildAssistantResultHints } from "../src/assistantQuality.ts";
...
describe("assistant quality helpers", () => {
  ...
  it("builds post-submit hints from skipped items and weak imported lead fields", () => {
    ...
    const hints = buildAssistantResultHints(result);
  ...
  it("groups post-submit result hints by follow-up urgency", () => {
    const groups = buildAssistantResultGroups({
      created: 1,
      updated: 1,
      dropped: 0,
      total: 2,
